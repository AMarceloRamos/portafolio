            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-12 portfolio-submenu text-center">
                    <ul class="filter">
                        ...
                        <li><a href="#" data-filter=".html">Diseño Web</a></li>
                        <li><a href="#" data-filter=".graphic">Diseño Digital</a></li>
                        <li><a href="#" data-filter=".wordpress">NodeJS</a></li>
                        <li><a href="#" data-filter=".php">Android Studio</a></li>
