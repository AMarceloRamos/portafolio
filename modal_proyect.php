...
$(document).ready(function () {
    $(".portfolio-link").click(function () {
        var idProyecto = $(this).data("id"); // Obtener el ID del proyecto

        // Petición AJAX para obtener los datos del proyecto
        $.ajax({
            url: "obtener_proyecto.php",
            type: "GET",
            data: { id: idProyecto },
            success: function (data) {
                var proyecto = JSON.parse(data); // Convertir JSON a objeto
                ...
                if(proyecto.Error) {
                    ...
                    $("#modal-imagen").attr("src", proyecto.img);
