<footer>
        <div class="container-fluid wrapper">
            <div class="col-lg-12 footer-info">
                ...
                <img  style="width:30%;"id="logo" src="img/logo2.png" alt="logo" >
                </a>
                </a>
                <p class="footer-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis
                    aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
            </div>
            <div class="col-sm-6 col-md-12 social-icons-footer">
                <ul class="list-inline social-buttons">
                    <li><a href="#"><i class="fa fa-twitter"></i></a>
                    </li>
                    <li><a href="https://www.linkedin.com/in/adri%C3%A1n-ramos-b3869447/" target="t_bank"><i class="fa fa-linkedin"></i></a>
                    </li>
                ...
                <!-- <li><a href="https://www.linkedin.com/in/adri%C3%A1n-ramos-b3869447/" target="t_bank"><i class="fa fa-linkedin"></i></a>
                <li><a href="https://github.com/AMarceloRamos" target="t_bank"><i class="fa fa-github"></i></a> -->

            </div>
            <div class="col-sm-12 col-md-12 col-lg-12 copyright-bottom">
                <span class="copyright">Copyright &copy;<?php echo date("Y") ;?> Created By <a href="" target="_blank">Adrian Ramos</a> </span>
            </div>
        </div>
    </footer>
    <!-- Scroll-up -->
    ...
    <div id="theme-settings">
        ...
        <div class="color">
            <span class="settings-title">Selector de tema de color</span>
            <ul class="gradients">
                <li>
                    <div class="gradient1">
                    </div>
