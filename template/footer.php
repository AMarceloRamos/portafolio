        ...
        <div class="container-fluid wrapper">
            ...
            <div class="col-sm-6 col-md-12 social-icons-footer">
                <ul class="list-inline social-buttons">
                    <li><a href=https://www.google.cl"><i class="fa fa-twitter"></i></a>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <p>
                            <strong>Want this flat style illustrations? </strong>You can download it for free, courtesy
                            of <a href="#">edubd.net</a>, or you can download it <a href="#">here</a>.
                        </p>
                        ...
                        <button type="button" class="btn btn-xl" data-dismiss="modal"><i class="fa fa-times"></i> Close
                            Project</button>
                    </div>
                </div>
            </div>
