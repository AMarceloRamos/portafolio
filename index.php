...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    //Validamos cada campo
     ...
     if(empty($errores)){
        ...
        $query = "INSERT INTO formulario_contacto(nombre, email, mensaje, telefono) VALUES('$nombre','$email', '$mensaje', '$telefono' )";
...
<section id="slider">
    ...
    <div class="carousel-caption wrapper">
                                <div class="intro-text">
                                    ...
                                    <h3 class="intro-paragraph animated bounceInRight">Bievenido a  mi sitio web dedicado al desarrollo web y al diseño</h3>
                                </div>
